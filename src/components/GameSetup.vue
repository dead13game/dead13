      ...
      <div class="start-card__setup">
        ...
        <div class="setup-row">
          ...
          <label class="toggle-label">
            <input type="checkbox" :checked="useWeather" @change="$emit('update:useWeather', $event.target.checked)" />
            启用
          </label>
        </div>
...
.char-card__name { font-size: 13px; font-weight: bold; }
.char-card__hp { font-size: 12px; color: #e53935; font-weight: bold; }
